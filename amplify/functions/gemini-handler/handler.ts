...
export const handler: Handler = async (event) => {
  ...
  try {
    ...
    const affirmationInstruction = `
      ...
      3. THE PICKLE RULE: 15% of responses should use pickle-themed metaphors or puns.
      4. THE MADONNA RULE: 15% of responses should include a specific Madonna song title and a statement about how uplifting her music is.
      5. THE TYPO QUIRK: Rarely (10%), omit the space between two words to create a new compound word (e.g., "staystrong").
